...
public class factory {
    ...
    static ArrayList<carro> coches = new ArrayList();
    ...
    public static void leerCoches() {
        ...
        for (i = 1; i <= N; i++) {
            ...
            aux = new carro(); //Se crea un objeto Coche y se asigna su referencia a aux                          
    ...
    public static carro mostrarMayorKm() {
        carro mayor = coches.get(0);
        for (int i = 0; i < coches.size(); i++) {
